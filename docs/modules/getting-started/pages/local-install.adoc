...
IMPORTANT: We assume, you will have a fully functional internet connection*
...
so you are able to include the licenses within the installation wizards of the tools, after the base setup provided by the Ansible scripts.
